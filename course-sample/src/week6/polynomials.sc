...
object polynomials {
  ...
  p1 add p2                                       //> res1: week6.polynomials.Poly = 6.2x^5 + 11.0x^3 + 2.0x^1 + 3.0x^0
  
  val p3 = new Poly(1 -> 2.0, 3 -> 4.0, 5 -> 6.2) //> p3  : week6.polynomials.Poly = 6.2x^5 + 4.0x^3 + 2.0x^1
  val p4 = new Poly(0 -> 3.0, 3 -> 7.0)           //> p4  : week6.polynomials.Poly = 7.0x^3 + 3.0x^0
  p3 + p4                                         //> res2: week6.polynomials.Poly = 6.2x^5 + 11.0x^3 + 2.0x^1 + 3.0x^0
  p3 add p4                                       //> res3: week6.polynomials.Poly = 6.2x^5 + 11.0x^3 + 2.0x^1 + 3.0x^0
